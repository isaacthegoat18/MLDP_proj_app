...
# --- Load model and feature columns (do this once, outside the button block) ---
...
with st.sidebar:
    ...
    #employment_type = st.selectbox("Employment Type", ['FT', 'PT', 'CT', 'FL'], index=0) # Default to FT
